    ...
    <el-dialog
      ...
      width="60%">
         <el-descriptions title="公告详情">
           <el-descriptions-item label="公告标题" span="3">{{annoInfo.title}}</el-descriptions-item>
           <el-descriptions-item label="公告发布者">{{annoInfo.releaseName}}</el-descriptions-item>
           <el-descriptions-item label="公告发布时间" span="3">{{annoInfo.releaseTime}}</el-descriptions-item>
