<template>
  <div class="app-container">
      ...
      <div class="left-botton">
        <el-row>
          ...
          <el-tooltip class="item" effect="light" content="导出数据" placement="top-start">
              <el-button type="success" icon="el-icon-download" circle @click="handleExportXls('登录日志')"/>
          </el-tooltip>
    ...
    <el-table :data="tableData" border style="width: 100%" stripe max-height="520px"
      ...
      <el-table-column align="center" show-overflow-tooltip prop="loginname" label="登录用户名" width="250" />
      <el-table-column align="center" show-overflow-tooltip prop="ip" label="IP地址" width="250" />
      <el-table-column align="center" show-overflow-tooltip prop="opt" label="操作" width="225" />
      <el-table-column align="center" show-overflow-tooltip prop="loginRole" label="登录者角色" width="250" />
      <el-table-column align="center" show-overflow-tooltip prop="optTime" label="操作时间" width="200" />
  ...
  export default {
    ...
    methods: {
      ...
      handleExportXls(fileName){
        ...
        exportLoginLog(fileName).then((res) => {
            //
      ...
      handleGetLoginLogList(pageCurrent, pageSize, keyword, value) {
        ...
        if(this.selectTime != ''){
          ...
          getLoginLogs(pageCurrent, pageSize, keyword, value, startTime, endTime).then((res) => {
